...
(* OASIS_START *)
(* DO NOT EDIT (digest: 61cc454d478e4a9b3ecf012b5c8a72c2) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-block", None);
                           FindlibPackage ("mirage-block-lwt", None);
                   ...
                   {
                      lib_modules = ["Block_ccm"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-block-ccm";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "example programs.";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Use Bisect to generate coverage data.";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mirage_block_ccm";
                           FindlibPackage ("nocrypto.unix", None);
                           ...
                           FindlibPackage ("mirage-block-unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "ccmblock.ml"});
               Library
                 ({
                     cs_name = "testlib";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      lib_modules = ["Block_ccm_tests"; "Fake_block"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "testrunner.ml"});
               Test
                 ({
                     cs_name = "it";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "}\208\011l]\217\167\189\169\246\0168e\230\199R";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
